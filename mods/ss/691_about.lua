...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    ...
    if fields.inv_tabs == "6" then
        ...
        local formspec = table_concat({
            ...
            "size[22.2,10.5,true]",
            "position[0.5,0.45]",
            "tabheader[0,0;inv_tabs;Main,Bundle,Skills,Settings,?,*;6;true;true]",
            "hypertext[0.2,0.2;4,1.5;about_title;",
            "<style color=#AAAAAA size=16><b>ABOUT</b></style>]",

            "hypertext[0.5,1.0;5,1;game_title;",
            "<style color=#AAAAAA size=17><b>Survival Story v0.0.2</b></style>]",
        ...
        debug(flag1, "  did not click on main ABOUT tab")
