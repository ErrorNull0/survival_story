...
local function get_fs_help(p_data)
    ...
    local fs_part_1 = table_concat({
        ...
        "size[22.2,10.5,true]",
        "position[0.5,0.45]",
        "tabheader[0,0;inv_tabs;Main,Bundle,Skills,Settings,?,*;5;true;true]",
    ...
    if help_topic == "" then
            ...
            if subtopic == help_subtopic then
                button_element = table.concat({ fs_part_3,
                    ...
                    "button[",
                        ...
                        ";2.6,0.7;subtopic_", subtopic, ";", subtopic,
                    "]"
                })
            else
                button_element = table.concat({ fs_part_3,
        ...
        if help_subtopic == "" then
            ...
            fs_part_4 = table.concat({
                "hypertext[12.5,0.8;9.2,9;topic_text;",
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    ...
    if fields.inv_tabs == "5" then
        ...
        debug(flag1, "  did not click on main HELP tab")
